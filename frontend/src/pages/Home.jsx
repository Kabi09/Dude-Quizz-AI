...
export default function Home(){
  // 👇 default-aa 10,11,12 show aagum
  ...
  useEffect(()=> {
    ...
    getClasses()
      .then(data => {
        // API data ok-na thatha use pannuvom
        if (Array.isArray(data) && data.length) {
          setClasses(data);
        }
      })
      .catch(()=> {
        // error-na default classes-la thaan irukkattum
      ...
      <div className="grid cols-3">
        {classes.map(c => (
          <div
            ...
            onClick={()=>nav(`/classes/${c.classId}/subjects`)}
          >
            <div style={{display:'flex', justifyContent:'space-between', alignItems:'center'}}>
              ...
              <div style={{fontSize:12,color:'#fff',background:'#111827',padding:'6px 10px',borderRadius:8}}>
                Start
              </div>
            </div>
          </div>
